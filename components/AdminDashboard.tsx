...
import { Activity, AlertTriangle, BarChart3, Building2, CreditCard, FileText, LogOut, RefreshCw, ShieldCheck, Users, Wallet, Receipt, Sparkles } from "lucide-react";
...
const sections = [["overview", "Vue générale", Activity], ["users", "Utilisateurs", Users], ["subscriptions", "Abonnements", CreditCard], ["purchases", "Achats & recharges", Receipt], ["integrations", "Intégrations", Building2], ["audit", "Journal d’audit", FileText]] as const;
