       ...
       <section className="hero">
        <div className="container hero-grid hero-vendeo-grid">
          <div className="hero-title hero-copy">
            <h1 className="hero-title-gradient">Gère, analyse et<br/>optimise ton activité<br/>digitale.</h1>
