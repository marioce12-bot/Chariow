  ...
  return <main>
      ...
      <section className="section problem-section">
        <div className="container">
          <div className="section-head"><div><h2>{t("landing.problem.title1")}<br/>{t("landing.problem.title2")}</h2></div><p>{t("landing.problem.paragraph")}</p></div>
      ...
      <section className="section" id="comment">
        <div className="container">
          <div className="section-head"><div><span className="eyebrow">{t("landing.how.eyebrow")}</span><h2>{t("landing.how.title1")}<br/>{t("landing.how.title2")}</h2></div><p>{t("landing.how.paragraph")}</p></div>
          <div className="how-grid" ref={howLine.ref}>
            <div className="how-line"><div className={`how-line-fill ${howLine.inView ? "filled" : ""}`}/></div>
            <article className="step-card"><span className="step-num mono">{t("landing.how.s1num")}</span><h3>{t("landing.how.s1title")}</h3><p>{t("landing.how.s1")}</p></article>
            <article className="step-card"><span className="step-num mono">{t("landing.how.s2num")}</span><h3>{t("landing.how.s2title")}</h3><p>{t("landing.how.s2")}</p></article>
            <article className="step-card"><span className="step-num mono">{t("landing.how.s3num")}</span><h3>{t("landing.how.s3title")}</h3><p>{t("landing.how.s3")}</p></article>
            <article className="step-card"><span className="step-num mono">{t("landing.how.s4num")}</span><h3>{t("landing.how.s4title")}</h3><p>{t("landing.how.s4")}</p></article>
          </div>
        </div>
      </section>
      ...
      <section className="section features-section" id="fonctionnalites">
        <div className="container">
          <div className="section-head"><div><span className="eyebrow">{t("landing.features.eyebrow")}</span><h2>{t("landing.features.title1")}<br/>{t("landing.features.title2")}</h2></div><p>{t("landing.features.paragraph")}</p></div>
     ...
     {proofImages.length ? <section className="section" style={{paddingTop:0}}><div className="container"><div className="section-head"><div><span className="eyebrow">{t("landing.proof.eyebrow")}</span><h2>{t("landing.proof.title1")}<br/>{t("landing.proof.title2")}</h2></div><p>{t("landing.proof.paragraph")}</p></div></div><div className="proof-carousel"><div className="proof-track">{[0,1].map((copy) => <div className="proof-group" key={copy} aria-hidden={copy===1}>{proofImages.map((proof) => <div className="proof-card" key={`${copy}-${proof.src}`}><Image src={proof.src} alt={proof.alt} width={497} height={proof.height}/></div>)}</div>)}</div></div></section> : null}

      <section className="section" id="tarifs"><div className="container"><div className="section-head"><div><span className="eyebrow">{t("landing.pricing.eyebrow")}</span><h2>{t("landing.pricing.title1")}<br/>{t("landing.pricing.title2")}</h2></div><p>{t("landing.pricing.paragraph")}</p></div><div className="pricing-wrap" style={{maxWidth:400,margin:'0 auto'}}><article className="price-card pro"><span className="pill" style={{marginBottom:18}}>{t("landing.pricing.pill")}</span><h3>Vendeo</h3><div className="price">{t("landing.pricing.price")} <small>{t("landing.pricing.perMonth")}</small></div><ul><li><Check className="check" size={15}/>{t("landing.pricing.b1")}</li><li><Check className="check" size={15}/>{t("landing.pricing.b2")}</li><li><Check className="check" size={15}/>{t("landing.pricing.b3")}</li><li><Check className="check" size={15}/>{t("landing.pricing.b4")}</li><li><Check className="check" size={15}/>{t("landing.pricing.b5")}</li></ul><Link href="/register" className="btn btn-lime" style={{width:'100%'}}>{t("landing.pricing.cta")} <ArrowRight size={15}/></Link></article></div></div></section>

    <section className="section" id="faq"><div className="container"><div className="section-head"><div><span className="eyebrow">{t("landing.faq.eyebrow")}</span><h2>{t("landing.faq.title1")}<br/>{t("landing.faq.title2")}</h2></div><p>{t("landing.faq.paragraph")}</p></div><div className="faq-list">{faqs.map(([q,a],i)=><div className="faq-item" key={q}><button className="faq-question" onClick={()=>setOpen(open===i?null:i)} aria-expanded={open===i}>{q}<span>{open===i?'−':'+'}</span></button>{open===i&&<div className="faq-answer">{a}</div>}</div>)}</div></div></section>

     <section className="section" style={{paddingTop:0}}><div className="container"><div className="cta"><span className="eyebrow">{t("landing.cta.eyebrow")}</span><h2>{t("landing.cta.title1")}<br/>{t("landing.cta.title2")}</h2><p>{t("landing.cta.paragraph")}</p><Link href="/register" className="btn btn-dark">{t("landing.cta.button")} <ArrowRight size={16}/></Link></div></div></section>
