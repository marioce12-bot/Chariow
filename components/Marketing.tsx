...
export function Marketing() {
  ...
  return <main>
    ...
    <section className="section" style={{paddingTop:0}}><div className="container"><div className="cta"><span className="eyebrow">Ton prochain bon choix</span><h2>Tes ventes parlent déjà.<br/>Il est temps de les écouter.</h2><p>Connecte ta boutique et découvre ton premier insight en moins de 2 minutes.</p><Link href="/register" className="btn btn-dark">Créer mon espace <ArrowRight size={16}/></Link></div></div></section>
