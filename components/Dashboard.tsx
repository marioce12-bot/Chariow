...
function Overview({
  ...
  return <div className="dashboard-home">
    <div className="home-greeting"><span className="eyebrow">Pilotage de rentabilité</span><h1>Bonjour, {greeting}</h1><p>Une lecture simple de ton activité Chariow et Meta Ads.</p></div>
